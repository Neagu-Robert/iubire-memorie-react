...
const evenimenteData = [
  {
    ...
    description: "Magia sărbătorilor de iarnă, când totul strălucește și inimile sunt pline de bucurie și recunoștință.",
    icon: "🎄",
  ...
  },
  {
    ...
    description: "Căldura familiei și bucuria de a fi împreună în momentele cele mai importante ale anului.",
    icon: "🎂",
  ...
  },
  {
    id: 5,
    title: "Absolviri",
    description: "Sfârșitul unei călătorii și începutul alteia - diplomele care marchează realizările noastre academice.",
    icon: "🎓",
  ...
  },
  {
    ...
    description: "Momentele spontane petrecute alături de oamenii care contează cu adevărat în viața noastră.",
    icon: "👨‍👩‍👧‍👦",
  ...
  },
  {
    ...
    description: "Sărbătoarea dragostei când inimile bat la unison și fiecare gest devine o declarație de iubire.",
    icon: "💝",
    date: "14 Februarie",
    ...
    <section id="timeline" className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-20">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-600 max-w-2xl">
              Sărbători și momente de neuitat care ne-au marcat călătoria împreună
            </p>
          </div>
          <button
      ...
      {expandedItem && (
        <div 
          ...
          style={{
            background: `linear-gradient(135deg, ${evenimenteData.find(item => item.id === expandedItem)?.color.replace('from-', '').replace(' to-', ', ')})`,
          }}
        >
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-lg text-gray-700 mb-8">
                {evenimenteData.find(item => item.id === expandedItem)?.description}
              </p>
